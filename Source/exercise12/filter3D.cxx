...
int main( int argc, char *argv[] )
{
  ...
  if( argc < 8 )
    ...
    std::cerr << " inputImage  outputImage seedX seedY seedZ multiplier iterations" << std::endl;
    return 1;
    }
  ...
  confidenceConnected->SetMultiplier( atof( argv[6] ) );
  confidenceConnected->SetNumberOfIterations( atoi( argv[7] ) );
