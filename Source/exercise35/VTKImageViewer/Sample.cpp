...
BOOL CSampleApp::InitInstance()
{
  ...
  // No new doc at startup; force user to use file open or to choose
  // a new blank document manually. (New blank document does not work
  // well with this sample application, so disable it here to avoid
  // the VTK error output window that shows up when you do try it...)
  //
